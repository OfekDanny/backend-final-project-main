"""Official test script from the project spec, adapted with local URLs."""
import requests
import sys

a = "http://localhost:3001"  # logs
b = "http://localhost:3002"  # users
c = "http://localhost:3003"  # costs
d = "http://localhost:3004"  # about

output = open("spec_test_output.txt", "w")
sys.stdout = output
